...
|--------------------------------------------|---------|----------|----------------------------------------------------|
| [Xen](https://github.com/XenLanguage/Xen)  | 0.5.4   |C         | Loosely-typed, imperative scripting language       |
| [clic](https://github.com/jakerieger/clic) | 0.1.1   |C         | Header-only library for building CLI applications  |
